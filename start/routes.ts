...
Route.group(() => {
  ...
  Route.group(() => {
    ...
    Route.get('/farmer/:id', 'IncomesController.getFarmerIncomes')
  ...
  Route.group(() => {
    ...
    Route.get('/farmer/:id', 'ExpensesController.getFarmerExpenses')
...
Route.group(() => {
  ...
  Route.group(() => {
    ...
    Route.get('/farmer/:id', 'CropsController.getSingleFarmerCrops')
  ...
  Route.group(() => {
    ...
    Route.get('/farmer/:id', 'CropHealthController.getFarmerCropHealths')
  ...
  Route.group(() => {
    ...
    Route.get('/farmer/:id', 'LivestockController.getSingleFarmerLivestock')
  ...
  Route.group(() => {
    ...
    Route.get('/farmer/:id', 'LivestockHealthController.getFarmerLivestockHealths')
